      ...
      <div className="container mx-auto px-4 relative z-10">
        <div className="flex flex-col items-center">
          <motion.img 
            ...
            alt="RETSBA" 
            className="w-full max-w-3xl mx-auto pulse-animation villain-shadow"
          ...
          >
            <h2 className="text-stroke text-white text-4xl md:text-6xl mb-4">THE VILLAIN HAS ARRIVED</h2>
            <p className="text-stroke text-white text-xl md:text-2xl max-w-2xl mx-auto">
              The nemesis of Pudgy Penguins is here to wreak havoc on the Abstract blockchain
            </p>
