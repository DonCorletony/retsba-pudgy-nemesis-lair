...
const TokenomicsSection = () => {
  return <section id="tokenomics" className="py-20 bg-retsba text-white relative">
      <div className="container mx-auto px-4">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
          <motion.div className="bg-black rounded-lg p-8 text-center hover-float" initial={{
          opacity: 0,
          y: 30
        }} whileInView={{
          opacity: 1,
          ...
          delay: 0.2
            ...
            <p className="text-stroke text-white text-2xl mb-2">860,000,000 tokens (140,000,000 burned.)</p>
          ...
          <motion.div className="bg-black rounded-lg p-8 text-center hover-float md:col-span-2 lg:col-span-1" initial={{
          opacity: 0,
          y: 30
        }} whileInView={{
          opacity: 1,
          ...
          delay: 0.6
            ...
            <p className="text-stroke text-white text-lg mb-2 break-all">
          </p>
        ...
        delay: 0.8
          ...
          <img src="/lovable-uploads/76403efb-8e4d-4a9b-bfaa-c4e4454f5902.png" alt="Retsba Character" className="max-w-xs villain-shadow animate-float" />
        </motion.div>
      </div>
    </section>;
};
