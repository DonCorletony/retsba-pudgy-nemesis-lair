...
const TokenomicsSection = () => {
  return (
    <section id="tokenomics" className="py-20 bg-black text-white relative">
      <div className="container mx-auto px-4">
        ...
        >
          ...
          <div className="w-24 h-1 bg-retsba mx-auto"></div>
        </motion.div>
        
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
          <motion.div 
            className="bg-retsba rounded-lg p-8 text-center hover-float"
          ...
          >
            <div className="flex justify-center mb-6">
              <Coins size={60} className="text-black" />
            </div>
          ...
          >
            <div className="flex justify-center mb-6">
              <DollarSign size={60} className="text-black" />
            </div>
          ...
          <motion.div 
            className="bg-retsba rounded-lg p-8 text-center hover-float md:col-span-2 lg:col-span-1"
            initial={{ opacity: 0, y: 30 }}
            whileInView={{ opacity: 1, y: 0 }}
            viewport={{ once: true }}
          ...
          >
            <div className="flex justify-center mb-6">
              <Link size={60} className="text-black" />
            </div>
